...
case "$_cb_ports" in *9090*) _row "${_lab}viz${_r}   http://persona-0020-2:9090?url=rerun%2Bhttp%3A%2F%2Fpersona-0020-2%3A9876%2Fproxy" ;; esac
printf '  %s┗━━%s\n\n' "$_or" "$_r"
unset _cb_box _cb_repo _cb_gpu _cb_ports _cb_agent _e1 _e2 _e3 _or _lab _r
